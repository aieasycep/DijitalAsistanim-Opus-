...
// Imported from the leaf modules rather than the `@/components/approvals`
// barrel: this file is a client component, and the barrel also re-exports the
// server components, which reach `@/lib/db` and its service-role key. A barrel
// import here would drag that whole graph across the client boundary.
import { APPROVALS_PATH } from '@/components/approvals/contract'
import { approvalMessages } from '@/components/approvals/messages'
import { messages } from '@/lib/messages'

/**
 * The approvals area's error boundary.
 *
 ...
 * same render, or go back to the oversight page, which settles each panel
