...
// Imported from the leaf modules rather than the `@/components/privacy` barrel:
// this file is a client component, and the barrel also re-exports the server
// components, which reach `@/lib/queries/privacy` and through it the
// service-role client. A barrel import here would drag that whole graph across
// the client boundary.
import { PRIVACY_PATH } from '@/components/privacy/contract'
import { privacyMessages } from '@/components/privacy/messages'
import { messages } from '@/lib/messages'

/**
 * The privacy area's error boundary.
 *
 ...
 * same render, or go back to the overview, which settles each panel separately
    ...
    <div className="p-4">
      <div role="alert" className="bo-panel mx-auto max-w-lg p-6 text-center">
        ...
        <div className="mt-4 flex items-center justify-center gap-2">
          ...
          >
            {privacyMessages.queue.backToOverview}
          </Link>
        </div>
      </div>
    </div>
