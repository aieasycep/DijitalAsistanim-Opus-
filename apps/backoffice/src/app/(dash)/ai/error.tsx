...
// Imported from the leaf modules rather than the `@/components/ai` barrel:
...
import { AI_PATH } from '@/components/ai/contract'
import { aiMessages } from '@/components/ai/messages'

/**
 * The AI area's error boundary, covering all three of its routes.
 *
 ...
 * same render, or fall back to the spend page, which settles each panel
