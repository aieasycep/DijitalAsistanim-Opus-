...
/**
 * The admin-management area's error boundary.
 *
 * It sits at this segment rather than at the root, so a failed query takes down
 * this section and not the whole console, and it offers a way back to the
 * roster — which settles each panel separately and will usually come up.
 *
