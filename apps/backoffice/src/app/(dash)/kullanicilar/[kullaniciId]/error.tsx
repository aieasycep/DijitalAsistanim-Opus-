 ...
 *
 * Narrower than the area boundary above it: a failure here is almost always one
 * view being unreachable, and the operator's next move is either to retry or to
 * go back to the roster and open a different account. Both are offered; neither
 * is a dead end. As everywhere else in this tool, nothing from the thrown error
 * is rendered except its digest.
 */
