    ...
    <section className="bo-panel overflow-hidden" aria-hidden="true">
      ...
      {Array.from({ length: rows }, (_unused, index) => (
        ...
        >
          ...
          <span className="bo-skeleton ml-auto block h-3 w-16" />
        </div>
      ))}
    </section>
  )
  ...
  return (
    <>
      ...
      <div className="mb-4 flex flex-col gap-3" aria-hidden="true">
        <div>
          <span className="bo-skeleton block h-5 w-64" />
      ...
      <div className="flex flex-col gap-4" aria-hidden="true">
        ...
        <div className="bo-panel px-3 py-2">
          <span className="bo-skeleton block h-7 w-full max-w-2xl" />
        </div>
  ...
  return (
    <>
      ...
      <div className="mb-4 flex flex-col gap-2" aria-hidden="true">
        <span className="bo-skeleton block h-2.5 w-56" />
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {Array.from({ length: 6 }, (_unused, index) => (
              <div key={index} className="flex flex-col gap-1">
                ...
                <span className="bo-skeleton block h-4 w-32" />
              </div>
            ))}
          </div>
        </section>
...
export function GrantFormSkeleton() {
  return (
    <>
      <span className="sr-only" role="status">
        {messages.states.loading}
