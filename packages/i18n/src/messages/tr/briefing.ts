...
export const briefing = {
  ...
  weekly: {
    ...
    stillOpen: {
      zero: 'Açık kalan yok',
      one: '1 konu açık kaldı',
      other: '{count} konu açık kaldı',
    },
...
export const evening = {
  ...
  leftOver: {
    zero: 'Bugünden bir şey kalmadı.',
    one: 'Bugünden 1 madde kaldı.',
    other: 'Bugünden {count} madde kaldı.',
  },
  ...
  tomorrowMeetings: {
    zero: 'Yarın toplantın yok.',
    one: 'Yarın 1 toplantın var.',
    other: 'Yarın {count} toplantın var.',
  },
  tomorrowFirst: 'İlk işin {time}: {title}',
  tomorrowDeadlines: {
    zero: 'Yarın son tarih yok.',
    one: 'Yarın 1 son tarih var.',
    other: 'Yarın {count} son tarih var.',
  },
