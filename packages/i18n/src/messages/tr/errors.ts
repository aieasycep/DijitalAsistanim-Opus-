...
export const errors = {
  ...
  mail_provider_unavailable: 'Mail sağlayıcına şu an ulaşılamıyor. Var olan mailleri görmeye devam edebilirsin.',
  calendar_provider_unavailable: 'Takvim sağlayıcına şu an ulaşılamıyor. Programın son eşitlemedeki hâliyle görünüyor.',
  ...
  ai_invalid_output: 'Bu sonuçtan emin olamadık, o yüzden göstermiyoruz. Tekrar denemek ister misin?',
  ...
  unsupported_file_type: 'Bu dosya türünü okuyamıyoruz. Fotoğraf, PDF veya metin dosyası deneyebilirsin.',
  url_not_allowed: 'Bu bağlantıyı açamıyoruz. Güvenlik nedeniyle yalnızca herkese açık adresleri okuyoruz.',
  ...
  subscription_error: 'Abonelik bilgisi okunamadı. Satın alımların kaybolmaz, birazdan tekrar bakacağız.',
